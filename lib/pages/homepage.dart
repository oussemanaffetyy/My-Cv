...
import 'package:mycv/pages/ExperiencePage.dart';
import 'package:mycv/pages/cv.dart';
import 'package:mycv/pages/mapPage.dart';
import 'package:mycv/pages/projectPage.dart';
...
class _BottomNavCustomState extends State<BottomNavCustom> {
  ...
  List<NavigationItem> items = [
    ...
    NavigationItem(
        const Icon(Icons.folder, color: Color.fromRGBO(17, 148, 170, 1)),
        const Text(
          'project',
          style: TextStyle(
